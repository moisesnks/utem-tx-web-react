...
const Register = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // ver si se puede integrar el componente LoginPassword o hacer uno parecido
        // porque después de la contraseña, se debe mandar el post al backend
        // con el email y el usuario, ese post finaliza con un OK que significa que 
        // se ha enviado el correo de verificacion, y se registró en el firebase auth.
        // Crear el componente registerPassword.jsx,
        /// acá hacer el navgate hacia registerPassword y pasarle en el state el email
        // navigate('/registerPassword', { state: { email: form.email } });
    }
    ...
    return (
        <div className="bg-secondary h-fit p-4 rounded-2xl shadow-xl mx-auto my-8 w-96">
            <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
                ...
                <h1 className="text-3xl font-bold text-left pb-2">Te damos la bienvenida a <span className='text-primary'> Utem Trades </span></h1>
                ...
                <div className="flex gap-2">
                    <label htmlFor="terms" className="relative cursor-pointer flex items-center">
                        <input
                            type="checkbox"
                            id="terms"
                            name="terms"
                        ...
                        <span className="ml-2 text-sm">
                            ...
                            <Link to="/terms" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary text-sm">
                                Términos de servicio
                            </Link>{' '}
                            y la{' '}
                            <Link to="/privacy" target="_blank" rel="noopener noreferrer" className="underline hover:text-primary text-sm">
                ...
                <button type="submit" className="bg-primary hover:opacity-75 text-black rounded-lg p-2 font-bold disabled:bg-disabled disabled:cursor-not-allowed" disabled={isSubmitDisabled}>Siguiente</button>

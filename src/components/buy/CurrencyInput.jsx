    ...
    <div className="mb-4">
      ...
      <div className="flex items-center space-x-2 mt-2">
        <input
          ...
          className="flex-1 px-4 py-2 border rounded border-gray-700"
          readOnly={!isEditable}
        />
        <select
          value={selectedCurrency}
          onChange={(e) => onCurrencyChange(e.target.value)}
          className="px-4 py-2 border rounded border-gray-700"
        >
      ...
      <small className="block mt-1 text-gray-600">Saldo: {balance[selectedCurrency]} {selectedCurrency}</small>
